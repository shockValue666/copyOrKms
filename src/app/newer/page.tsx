    ...
    <div className='flex justify-center items-center'>
        ...
        <main className="flex-1 grid items-start p-4 gap-4 md:gap-8">
            ...
            <div className="grid gap-2">
                <h1 className="font-semibold text-lg">My Folders</h1>
            ...
            <Card>
                ...
                <div className="grid gap-1.5">
                    ...
                    <CardDescription>Contains all my photos</CardDescription>
                </div>
            ...
            <Card>
                ...
                <div className="grid gap-1.5">
                    ...
                    <CardDescription>Work-related files</CardDescription>
                </div>
                <Button className="ml-auto w-8 h-8" size="icon">
                    <ChevronRightIcon className="h-4 w-4" />
                    <span className="sr-only">View folder</span>
            ...
            <Card>
                ...
                <div className="grid gap-1.5">
                    ...
                    <CardDescription>My music collection</CardDescription>
                </div>
                <Button className="ml-auto w-8 h-8" size="icon">
                    <ChevronRightIcon className="h-4 w-4" />
                    <span className="sr-only">View folder</span>
